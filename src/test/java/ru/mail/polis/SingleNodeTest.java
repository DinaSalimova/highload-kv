...
/**
 * Unit tests for single node {@link KVServer} API
 *
...
public class SingleNodeTest extends TestBase {
    ...
    private static KVServer storage;
    @Rule
    ...
    public static void beforeAll() throws IOException, InterruptedException {
        ...
        storage = KVServerFactory.create(port, data, Collections.singleton(endpoint), KindOfServer.JERSEY);
        storage.start();
    }
    ...
    public void deleteAbsent() throws Exception {
        assertEquals(500, delete("absent").getStatusLine().getStatusCode());
    }
