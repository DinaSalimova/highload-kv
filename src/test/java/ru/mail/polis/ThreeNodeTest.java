...
/**
 * Unit tests for a three node {@link KVServer} cluster
 *
...
public class ThreeNodeTest extends ClusterTestBase {
    ...
    private File data1;
    private File data2;
    private KVServer storage0;
    private KVServer storage1;
    private KVServer storage2;
    ...
    public void beforeEach() throws IOException, InterruptedException {
        ...
        storage0 = KVServerFactory.create(port0, data0, endpoints, KindOfServer.JERSEY);
        storage0.start();
        storage1 = KVServerFactory.create(port1, data1, endpoints, KindOfServer.JERSEY);
        storage1.start();
        storage2 = KVServerFactory.create(port2, data2, endpoints, KindOfServer.JERSEY);
        storage2.start();
    }
